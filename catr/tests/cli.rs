...
const BUSTLE_SKIP: &str = "tests/inputs/the-bustle-skip.txt";
...
// --------------------------------------------------
#[test]
fn bustle_skip() -> TestResult {
    run(&[BUSTLE_SKIP], "tests/expected/the-bustle-skip.txt.out")
}

// --------------------------------------------------
#[test]
fn bustle_skip_n() -> TestResult {
    run(
        &["-n", BUSTLE_SKIP],
        "tests/expected/the-bustle-skip.txt.n.out",
    )
}

// --------------------------------------------------
#[test]
fn bustle_skip_b() -> TestResult {
    run(
        &["-b", BUSTLE_SKIP],
        "tests/expected/the-bustle-skip.txt.b.out",
    )
}
// --------------------------------------------------
#[test]
fn bustle_skip_e() -> TestResult {
    run(
        &["-E", BUSTLE_SKIP],
        "tests/expected/the-bustle-skip.txt.e.out",
    )
}
// --------------------------------------------------
#[test]
fn bustle_skip_s() -> TestResult {
    run(
        &["-s", BUSTLE_SKIP],
        "tests/expected/the-bustle-skip.txt.s.out",
    )
}
